...
while True:
    ...
    if result.multi_hand_landmarks:
        for hand_landmarks in result.multi_hand_landmarks:
            ...
            verificacao_indicador_polegar = distancia_indicador_polegar_x > 0.27 and distancia_indicador_polegar_y > 0.28
            verificacao_polegar_pulso = distancia_polegar_pulso_x > -0.57 and distancia_polegar_pulso_y > 0.140
            verificacao_anelar_pulso = distancia_anelar_pulso_y < 0.16

            # Condição de fez ou não o "L"
            l = "Nao fez o L"
            if verificacao_indicador_polegar and verificacao_polegar_pulso and verificacao_anelar_pulso:
                l = "Fez o L"

            cv2.putText(frame, f"status: {l}", (5, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
